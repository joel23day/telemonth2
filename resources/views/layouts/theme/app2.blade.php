...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <div id="preloader">
        <div class="loader">
            <img src="img/portada/loader.gif" alt="#" />
        </div>
    </div>
    <!-- end loader -->
    <!-- END LOADER -->
    ...
    <header class="top-header">
        <nav class="navbar header-nav navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.html"><img src="img/portada/logo2.png" alt="image"></a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link" href="cycv.html">Quienes Somos</a></li>
                        <li><a class="nav-link" href="contact.html">Contactanos</a></li>
                        <li><a class="nav-link active" style="background:#fff;color:#000;" href="contact.html">Iniciar Sesion</a></li>
                    </ul>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="pogoSlider" id="js-main-slider">
                    <div class="pogoSlider-slide" style="background-image:url(img/portada/slider-01.jpg);">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                    ...
                    <div class="pogoSlider-slide" style="background-image:url(img/sportada/slider-01.jpg);">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide_text">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 text_align_center">
                    <div class="full">
                        <img class="img-responsive" src="img/portada/resume_img.png" alt="#" />
                    </div>
                </div>
                            ...
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <img class="img-responsive" src="img/portada/img1.png" alt="#" />
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <img class="img-responsive" src="img/portada/img2.png" alt="#" />
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <img class="img-responsive" src="img/portada/img3.png" alt="#" />
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <img class="img-responsive" src="img/portada/img4.png" alt="#" />
                                    </div>
                                </div>
                            </div>
    ...
    <div class="section layout_padding theme_bg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 text_align_center">
                    <div class="full">
                        <img class="img-responsive" src="img/portada/resume_img2.png" alt="#" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="full">
                        <div class="center">
                            <img src="img/portada/icon1.png" alt="#" />
                        </div>
                        <div class="center">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="full">
                        <div class="center">
                            <img src="img/portada/icon2.png" alt="#" />
                        </div>
                        <div class="center">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="full">
                        <div class="center">
                            <img src="img/portada/icon3.png" alt="#" />
                        </div>
                        <div class="center">
    ...
    <footer class="footer-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="logo">
                        <a href="index.html"><img src="img/portada/footer_logo.png" alt="#" /></a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="full icon text_align_center">
                                <img src="img/portada/social1.png">
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="full icon text_align_center">
                                <img src="img/portada/social2.png">
                            </div>
                            <div class="full white_fonts text_align_center">
                        ...
                        <div class="col-md-4">
                            <div class="full icon text_align_center">
                                <img src="img/portada/social3.png">
                            </div>
                            <div class="full white_fonts text_align_center">
                                <p>+7586656566
                                    <br>+7586656566</p>
